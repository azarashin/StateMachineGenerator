...
def test_cpp_generator_01_dump():
...
def test_cpp_generator_01_01():
    cpp_generator = CPPGenerator()
    puml = open('./test/data/plant_uml/test01.puml', 'r').read()
    istate = open('./test/data/cpp/test01/BaseState.cpp').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cpp_generator)
    ...
    istate = open('./test/data/cpp/test01/BaseState.h').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cpp_generator)
...
def test_cpp_generator_01_02():
    cpp_generator = CPPGenerator()
    puml = open('./test/data/plant_uml/test01.puml', 'r').read()
    istate = open('./test/data/cpp/test01/IControllee.h').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cpp_generator)
...
def test_cpp_generator_01_03():
    cpp_generator = CPPGenerator()
    puml = open('./test/data/plant_uml/test01.puml', 'r').read()
    istate = open('./test/data/cpp/test01/ConsoleOutControllee.cpp').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cpp_generator)
    ...
    istate = open('./test/data/cpp/test01/ConsoleOutControllee.h').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cpp_generator)
...
def test_cpp_generator_01_04():
    cpp_generator = CPPGenerator()
    puml = open('./test/data/plant_uml/test01.puml', 'r').read()
    istate = open('./test/data/cpp/test01/StateController.cpp').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cpp_generator)
    ...
    istate = open('./test/data/cpp/test01/StateController.h').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cpp_generator)
...
def test_cpp_generator_01_05():
    cpp_generator = CPPGenerator()
    puml = open('./test/data/plant_uml/test01.puml', 'r').read()
    istate = open('./test/data/cpp/test01/Program.cpp').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cpp_generator)
...
def test_cpp_generator_01_06():
    cpp_generator = CPPGenerator()
    puml = open('./test/data/plant_uml/test01.puml', 'r').read()
    istate = open('./test/data/cpp/test01/StateState1.cpp').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cpp_generator)
    ...
    istate = open('./test/data/cpp/test01/StateState1.h').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cpp_generator)
...
def test_cpp_generator_01_07():
    cpp_generator = CPPGenerator()
    puml = open('./test/data/plant_uml/test01.puml', 'r').read()
    istate = open('./test/data/cpp/test01/StateState2.cpp').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cpp_generator)
    ...
    istate = open('./test/data/cpp/test01/StateState2.h').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cpp_generator)
