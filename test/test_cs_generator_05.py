...
def test_cs_generator_05_01():
    cs_generator = CSGenerator()
    puml = open('./test/data/plant_uml/test05.puml', 'r').read()
    istate = open('./test/data/cs/test05/BaseState.cs').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cs_generator)
...
def test_cs_generator_05_02():
    cs_generator = CSGenerator()
    puml = open('./test/data/plant_uml/test05.puml', 'r').read()
    istate = open('./test/data/cs/test05/IControllee.cs').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cs_generator)
...
def test_cs_generator_05_03():
    cs_generator = CSGenerator()
    puml = open('./test/data/plant_uml/test05.puml', 'r').read()
    istate = open('./test/data/cs/test05/ConsoleOutControllee.cs').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cs_generator)
...
def test_cs_generator_05_04():
    cs_generator = CSGenerator()
    puml = open('./test/data/plant_uml/test05.puml', 'r').read()
    istate = open('./test/data/cs/test05/StateController.cs').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cs_generator)
...
def test_cs_generator_05_05():
    cs_generator = CSGenerator()
    puml = open('./test/data/plant_uml/test05.puml', 'r').read()
    istate = open('./test/data/cs/test05/Program.cs').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cs_generator)
...
def test_cs_generator_05_06():
    cs_generator = CSGenerator()
    puml = open('./test/data/plant_uml/test05.puml', 'r').read()
    istate = open('./test/data/cs/test05/StateState1.cs').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cs_generator)
...
def test_cs_generator_05_07():
    cs_generator = CSGenerator()
    puml = open('./test/data/plant_uml/test05.puml', 'r').read()
    istate = open('./test/data/cs/test05/StateState2.cs').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cs_generator)
...
def test_cs_generator_05_08():
    cs_generator = CSGenerator()
    puml = open('./test/data/plant_uml/test05.puml', 'r').read()
    istate = open('./test/data/cs/test05/StateState4.cs').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cs_generator)
...
def test_cs_generator_05_09():
    cs_generator = CSGenerator()
    puml = open('./test/data/plant_uml/test05.puml', 'r').read()
    istate = open('./test/data/cs/test05/StateState21.cs').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cs_generator)
    assert 'StateState21.cs' in files
    expected = filter_code(istate)
    actual = filter_code(files['StateState21.cs'])
    assert expected == actual

def test_cs_generator_03_10():
    cs_generator = CSGenerator()
    puml = open('./test/data/plant_uml/test05.puml', 'r').read()
    istate = open('./test/data/cs/test05/StateState31.cs').read()
    generator = StateMachineGenerator()
    files = generator.generate_for_puml(puml, cs_generator)
    assert 'StateState31.cs' in files
    expected = filter_code(istate)
    actual = filter_code(files['StateState31.cs'])
    assert expected == actual
